...
define gui.accent_color = '#ec5d8d'
...
## 사용됩니다.
define gui.idle_small_color = '#ac9ba1'

## 버튼(button)과 막대(bar)에 커서를 올렸을 때(hovered) 사용됩니다.
define gui.hover_color = '#f54c84'
...
## 인터페이스에 사용됩니다.
define gui.interface_text_font = "Cafe24Classictype-v1.1.ttf"
